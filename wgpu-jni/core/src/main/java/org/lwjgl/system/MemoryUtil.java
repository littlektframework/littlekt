...
public final class MemoryUtil {
    ...
    public static long memAddress0Safe(Buffer buffer) {
        return buffer == null ? NULL : ACCESSOR.memAddress0(buffer);
    }
    ...
    public static long memAddress0Safe(CustomBuffer<?> buffer) {
        return buffer == null ? NULL : buffer.address0();
    }
    ...
    public static long memAddress(ShortBuffer buffer, int position) {
        return memAddress0(buffer) + (position << 1);
    }
    ...
    public static long memAddress(IntBuffer buffer, int position) {
        return memAddress0(buffer) + (position << 2);
    }
    ...
    public static long memAddress(LongBuffer buffer, int position) {
        return memAddress0(buffer) + (position << 3);
    }
    ...
    public static long memAddressSafe(ByteBuffer buffer, int position) {
        return buffer == null ? NULL : memAddress(buffer, position);
    }
