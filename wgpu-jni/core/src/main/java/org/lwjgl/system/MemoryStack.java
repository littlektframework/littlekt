...
import static org.lwjgl.system.StackWalkUtil.stackWalkIsSameMethod;
...
public class MemoryStack implements AutoCloseable {
    ...
    public ByteBuffer malloc(int alignment, int size) {
        return memByteBuffer(nmalloc(alignment, size), size);
    }
    ...
    public ByteBuffer calloc(int alignment, int size) {
        return memByteBuffer(ncalloc(alignment, size, 1), size);
    }
    ...
    public ShortBuffer mallocShort(int size) {
        return memShortBuffer(nmalloc(2, size << 1), size);
    }
    ...
    public ShortBuffer callocShort(int size) {
        return memShortBuffer(ncalloc(2, size, 2), size);
    }
    ...
    public IntBuffer mallocInt(int size) {
        return memIntBuffer(nmalloc(4, size << 2), size);
    }
    ...
    public IntBuffer callocInt(int size) {
        return memIntBuffer(ncalloc(4, size, 4), size);
    }
    ...
    public LongBuffer mallocLong(int size) {
        return memLongBuffer(nmalloc(8, size << 3), size);
    }
    ...
    public LongBuffer callocLong(int size) {
        return memLongBuffer(ncalloc(8, size, 8), size);
    }
    ...
    public FloatBuffer mallocFloat(int size) {
        return memFloatBuffer(nmalloc(4, size << 2), size);
    }
    ...
    public FloatBuffer callocFloat(int size) {
        return memFloatBuffer(ncalloc(4, size, 4), size);
    }
    ...
    public DoubleBuffer mallocDouble(int size) {
        return memDoubleBuffer(nmalloc(8, size << 3), size);
    }
    ...
    public DoubleBuffer callocDouble(int size) {
        return memDoubleBuffer(ncalloc(8, size, 8), size);
    }
    ...
    public PointerBuffer callocPointer(int size) {
        return memPointerBuffer(ncalloc(POINTER_SIZE, size, POINTER_SIZE), size);
    }
