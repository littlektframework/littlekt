...
final class MemoryAccess {
    ...
    interface MemoryAccessor {
        ...
        default byte memGetByte(long ptr) {
            return getByte(ptr);
        }

        default short memGetShort(long ptr) {
            return getShort(ptr);
        }

        default int memGetInt(long ptr) {
            return getInt(ptr);
        }

        default long memGetLong(long ptr) {
            return getLong(ptr);
        }

        default float memGetFloat(long ptr) {
            return getFloat(ptr);
        }

        default double memGetDouble(long ptr) {
            return getDouble(ptr);
        }

        default long memGetAddress(long ptr) {
            return getAddress(ptr);
        }

        default void memPutByte(long ptr, byte value) {
            putByte(ptr, value);
        }

        default void memPutShort(long ptr, short value) {
            putShort(ptr, value);
        }

        default void memPutInt(long ptr, int value) {
            putInt(ptr, value);
        }

        default void memPutLong(long ptr, long value) {
            putLong(ptr, value);
        }

        default void memPutFloat(long ptr, float value) {
            putFloat(ptr, value);
        }

        default void memPutDouble(long ptr, double value) {
            putDouble(ptr, value);
        }

        default void memPutAddress(long ptr, long value) {
            putAddress(ptr, value);
        }
    ...
    private abstract static class MemoryAccessorUnsafeAndroid extends MemoryAccessorUnsafeBase {
        ...
        private static class Arch32 extends MemoryAccessorUnsafeAndroid {
            ...
            @Override
            public void memPutAddress(long ptr, long value) {
                UNSAFE.putInt(null, ptr, (int) (value & 0xFFFFFFFF));
            }
        }
