...
import org.lwjgl.system.jni.jboolean
...
val CoreFoundation =
    "CoreFoundation"
        .nativeClass(MACOSX_PACKAGE) {
            ...
            ByteConstant("Boolean values.", "TRUE".."1", "FALSE".."0")
        ...
        """,
            ...
            CFBundleRef(
                ...
                CFURLRef.IN(
                    "bundleURL",
                    "the location of the bundle for which to create a {@code CFBundle} object"
                )
            )
            ...
            CFStringRef(
                ...
                ALLOCATOR,
                Unsafe..const..char_p.IN(
                        "cStr",
                        "the #NULL-terminated C string to be used to create the {@code CFString} object. The string must use an 8-bit encoding."
                    ),
                CFStringEncoding.IN(
                    "encoding",
            ...
            """
                ...
                CFURLPathStyle.IN(
                    "pathStyle",
                    "the operating system path style used in {@code filePath}",
                    PathStyles
                ),
                jboolean.IN(
                    "isDirectory",
