...
val JNINativeInterface =
    "JNINativeInterface"
        .nativeClass(JNI_PACKAGE, prefix = "JNI", prefixMethod = "") {
        ...
        """
            ...
            IntConstant("jboolean constants.", "FALSE".."0", "TRUE".."1")
            ...
            IntConstant("Used in {@code ReleaseScalarArrayElements}.", "COMMIT".."1", "ABORT".."2")
            ...
            java_lang_reflect_Method(
                ...
                jboolean.IN(
                    "isStatic",
                    "must be set to #TRUE if the method ID refers to a static field, and # FALSE otherwise"
                )
            )
            ...
            java_lang_reflect_Method(
                ...
                jboolean.IN(
                    "isStatic",
                    "must be set to #TRUE if {@code fieldID} refers to a static field, and #FALSE otherwise"
                )
            )
        ...
        """,
            ...
            fun ArrayElementsRoutines(
                name: String,
                elementType: PrimitiveType,
                arrayType: NativeType
            ) {
                elementType.p(
            ...
            """,
                    JNI_ENV,
                    AutoSizeResult("\$original.length")..arrayType.IN(
                            "array",
                            "the primitive array"
                        ),
        ...
        """,
                ...
                java_nio_Buffer.IN(
                    "buf",
                    "a direct {@code java.nio.Buffer} object (must not be #NULL)"
                ),
                returnDoc =
                    """
