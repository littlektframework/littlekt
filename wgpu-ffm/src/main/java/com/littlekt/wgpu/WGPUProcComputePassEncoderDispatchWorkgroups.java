...
public class WGPUProcComputePassEncoderDispatchWorkgroups {
    ...
    public interface Function {
        void apply(MemorySegment computePassEncoder, int workgroupCountX, int workgroupCountY, int workgroupCountZ);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcComputePassEncoderDispatchWorkgroups.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcComputePassEncoderDispatchWorkgroups.Function fi, Arena arena) {
