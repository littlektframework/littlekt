...
public class WGPUProcComputePipelineSetLabel {
    ...
    public interface Function {
        void apply(MemorySegment computePipeline, MemorySegment label);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcComputePipelineSetLabel.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcComputePipelineSetLabel.Function fi, Arena arena) {
