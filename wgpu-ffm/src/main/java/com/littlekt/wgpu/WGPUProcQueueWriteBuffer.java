...
public class WGPUProcQueueWriteBuffer {
    ...
    public interface Function {
        void apply(MemorySegment queue, MemorySegment buffer, long bufferOffset, MemorySegment data, long size);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcQueueWriteBuffer.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcQueueWriteBuffer.Function fi, Arena arena) {
