...
public class WGPUProcRenderPassEncoderSetBlendConstant {
    ...
    public interface Function {
        void apply(MemorySegment renderPassEncoder, MemorySegment color);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderPassEncoderSetBlendConstant.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderPassEncoderSetBlendConstant.Function fi, Arena arena) {
