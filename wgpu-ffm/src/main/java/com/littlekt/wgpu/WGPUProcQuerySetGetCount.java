...
public class WGPUProcQuerySetGetCount {
    ...
    public interface Function {
        int apply(MemorySegment querySet);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcQuerySetGetCount.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcQuerySetGetCount.Function fi, Arena arena) {
