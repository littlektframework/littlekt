...
public class WGPUProcRenderPassEncoderBeginOcclusionQuery {
    ...
    public interface Function {
        void apply(MemorySegment renderPassEncoder, int queryIndex);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderPassEncoderBeginOcclusionQuery.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderPassEncoderBeginOcclusionQuery.Function fi, Arena arena) {
