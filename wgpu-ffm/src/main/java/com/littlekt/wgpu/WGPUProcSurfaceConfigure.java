...
public class WGPUProcSurfaceConfigure {
    ...
    public interface Function {
        void apply(MemorySegment surface, MemorySegment config);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcSurfaceConfigure.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcSurfaceConfigure.Function fi, Arena arena) {
