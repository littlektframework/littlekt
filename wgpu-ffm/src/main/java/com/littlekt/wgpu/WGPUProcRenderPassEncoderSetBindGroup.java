...
public class WGPUProcRenderPassEncoderSetBindGroup {
    ...
    public interface Function {
        void apply(MemorySegment renderPassEncoder, int groupIndex, MemorySegment group, long dynamicOffsetCount, MemorySegment dynamicOffsets);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderPassEncoderSetBindGroup.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderPassEncoderSetBindGroup.Function fi, Arena arena) {
