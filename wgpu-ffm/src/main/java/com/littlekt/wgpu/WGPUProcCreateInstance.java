...
public class WGPUProcCreateInstance {
    ...
    public interface Function {
        MemorySegment apply(MemorySegment descriptor);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcCreateInstance.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcCreateInstance.Function fi, Arena arena) {
