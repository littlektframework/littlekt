...
public class WGPUProcComputePassEncoderPushDebugGroup {
    ...
    public interface Function {
        void apply(MemorySegment computePassEncoder, MemorySegment groupLabel);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcComputePassEncoderPushDebugGroup.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcComputePassEncoderPushDebugGroup.Function fi, Arena arena) {
