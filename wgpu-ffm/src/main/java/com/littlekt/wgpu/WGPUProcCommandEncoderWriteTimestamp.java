...
public class WGPUProcCommandEncoderWriteTimestamp {
    ...
    public interface Function {
        void apply(MemorySegment commandEncoder, MemorySegment querySet, int queryIndex);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcCommandEncoderWriteTimestamp.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcCommandEncoderWriteTimestamp.Function fi, Arena arena) {
