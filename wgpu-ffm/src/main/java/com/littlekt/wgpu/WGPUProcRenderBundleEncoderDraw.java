...
public class WGPUProcRenderBundleEncoderDraw {
    ...
    public interface Function {
        void apply(MemorySegment renderBundleEncoder, int vertexCount, int instanceCount, int firstVertex, int firstInstance);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderBundleEncoderDraw.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderBundleEncoderDraw.Function fi, Arena arena) {
