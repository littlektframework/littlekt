...
public class WGPUProcTextureGetSampleCount {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcTextureGetSampleCount.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcTextureGetSampleCount.Function fi, Arena arena) {
