...
public class WGPUProcRenderPassEncoderSetPipeline {
    ...
    public interface Function {
        void apply(MemorySegment renderPassEncoder, MemorySegment pipeline);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderPassEncoderSetPipeline.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderPassEncoderSetPipeline.Function fi, Arena arena) {
