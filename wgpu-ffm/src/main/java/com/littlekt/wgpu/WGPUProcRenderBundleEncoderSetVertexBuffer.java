...
public class WGPUProcRenderBundleEncoderSetVertexBuffer {
    ...
    public interface Function {
        void apply(MemorySegment renderBundleEncoder, int slot, MemorySegment buffer, long offset, long size);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderBundleEncoderSetVertexBuffer.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderBundleEncoderSetVertexBuffer.Function fi, Arena arena) {
