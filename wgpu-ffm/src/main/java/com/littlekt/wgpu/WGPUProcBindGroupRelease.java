...
public class WGPUProcBindGroupRelease {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcBindGroupRelease.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcBindGroupRelease.Function fi, Arena arena) {
