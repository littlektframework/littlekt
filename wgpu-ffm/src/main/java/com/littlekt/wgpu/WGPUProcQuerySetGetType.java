...
public class WGPUProcQuerySetGetType {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcQuerySetGetType.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcQuerySetGetType.Function fi, Arena arena) {
