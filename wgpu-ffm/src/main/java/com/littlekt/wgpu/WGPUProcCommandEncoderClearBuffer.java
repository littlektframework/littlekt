...
public class WGPUProcCommandEncoderClearBuffer {
    ...
    public interface Function {
        void apply(MemorySegment commandEncoder, MemorySegment buffer, long offset, long size);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcCommandEncoderClearBuffer.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcCommandEncoderClearBuffer.Function fi, Arena arena) {
