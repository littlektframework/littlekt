...
public class WGPUProcTextureGetWidth {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcTextureGetWidth.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcTextureGetWidth.Function fi, Arena arena) {
