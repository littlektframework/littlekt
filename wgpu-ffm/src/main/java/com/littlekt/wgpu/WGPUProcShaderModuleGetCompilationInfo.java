...
public class WGPUProcShaderModuleGetCompilationInfo {
    ...
    public interface Function {
        void apply(MemorySegment shaderModule, MemorySegment callback, MemorySegment userdata);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcShaderModuleGetCompilationInfo.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcShaderModuleGetCompilationInfo.Function fi, Arena arena) {
