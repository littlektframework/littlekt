...
public class WGPUInstanceRequestAdapterCallback {
    ...
    public interface Function {
        void apply(int status, MemorySegment adapter, MemorySegment message, MemorySegment userdata);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUInstanceRequestAdapterCallback.Function.class, "apply", $DESC);
