...
public class WGPUProcDeviceCreateBuffer {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcDeviceCreateBuffer.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcDeviceCreateBuffer.Function fi, Arena arena) {
