...
public class WGPUProcSamplerRelease {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcSamplerRelease.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcSamplerRelease.Function fi, Arena arena) {
