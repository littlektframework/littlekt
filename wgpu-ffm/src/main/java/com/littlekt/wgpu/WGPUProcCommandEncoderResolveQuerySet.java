...
public class WGPUProcCommandEncoderResolveQuerySet {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcCommandEncoderResolveQuerySet.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcCommandEncoderResolveQuerySet.Function fi, Arena arena) {
