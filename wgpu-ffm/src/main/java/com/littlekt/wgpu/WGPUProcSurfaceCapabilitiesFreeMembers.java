...
public class WGPUProcSurfaceCapabilitiesFreeMembers {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcSurfaceCapabilitiesFreeMembers.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcSurfaceCapabilitiesFreeMembers.Function fi, Arena arena) {
