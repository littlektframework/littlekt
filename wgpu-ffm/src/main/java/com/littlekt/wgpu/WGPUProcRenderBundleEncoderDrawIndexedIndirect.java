...
public class WGPUProcRenderBundleEncoderDrawIndexedIndirect {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderBundleEncoderDrawIndexedIndirect.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderBundleEncoderDrawIndexedIndirect.Function fi, Arena arena) {
