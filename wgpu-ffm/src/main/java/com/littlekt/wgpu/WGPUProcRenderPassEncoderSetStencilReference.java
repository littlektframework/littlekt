...
public class WGPUProcRenderPassEncoderSetStencilReference {
    ...
    public interface Function {
        void apply(MemorySegment renderPassEncoder, int reference);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderPassEncoderSetStencilReference.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcRenderPassEncoderSetStencilReference.Function fi, Arena arena) {
