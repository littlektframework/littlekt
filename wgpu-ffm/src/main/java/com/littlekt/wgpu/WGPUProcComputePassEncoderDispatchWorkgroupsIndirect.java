...
public class WGPUProcComputePassEncoderDispatchWorkgroupsIndirect {
    ...
    public interface Function {
        void apply(MemorySegment computePassEncoder, MemorySegment indirectBuffer, long indirectOffset);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcComputePassEncoderDispatchWorkgroupsIndirect.Function.class, "apply", $DESC);
