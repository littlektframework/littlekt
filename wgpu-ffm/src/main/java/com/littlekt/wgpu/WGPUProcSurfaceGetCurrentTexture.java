...
public class WGPUProcSurfaceGetCurrentTexture {
    ...
    public interface Function {
        void apply(MemorySegment surface, MemorySegment surfaceTexture);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcSurfaceGetCurrentTexture.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcSurfaceGetCurrentTexture.Function fi, Arena arena) {
