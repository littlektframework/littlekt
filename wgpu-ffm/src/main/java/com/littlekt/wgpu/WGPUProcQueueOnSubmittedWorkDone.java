...
public class WGPUProcQueueOnSubmittedWorkDone {
    ...
    public interface Function {
        void apply(MemorySegment queue, MemorySegment callback, MemorySegment userdata);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcQueueOnSubmittedWorkDone.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcQueueOnSubmittedWorkDone.Function fi, Arena arena) {
