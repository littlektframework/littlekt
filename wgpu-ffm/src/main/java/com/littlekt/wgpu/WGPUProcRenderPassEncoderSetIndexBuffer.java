...
public class WGPUProcRenderPassEncoderSetIndexBuffer {
    ...
    public interface Function {
        void apply(MemorySegment renderPassEncoder, MemorySegment buffer, int format, long offset, long size);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcRenderPassEncoderSetIndexBuffer.Function.class, "apply", $DESC);
