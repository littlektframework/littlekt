...
public class WGPULogCallback {
    ...
    public interface Function {
        void apply(int level, MemorySegment message, MemorySegment userdata);
    }
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPULogCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPULogCallback.Function fi, Arena arena) {
