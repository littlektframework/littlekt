...
public class WGPUProcSurfaceUnconfigure {
    ...
    private static final MethodHandle UP$MH = WGPU.upcallHandle(WGPUProcSurfaceUnconfigure.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(WGPUProcSurfaceUnconfigure.Function fi, Arena arena) {
