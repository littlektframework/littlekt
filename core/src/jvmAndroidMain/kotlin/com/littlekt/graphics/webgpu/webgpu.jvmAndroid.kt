...
actual class Queue(val segment: WGPUQueue) : Releasable {
    ...
    actual fun writeTexture(
        ...
        nativeWriteTexture(data, destination, size, layout, copySize)
    }
    ...
    actual fun writeBuffer(
        ...
        nativeWriteShortBuffer(data, buffer, offset, dataOffset, size)
    }
    actual fun writeBuffer(
        buffer: GPUBuffer,
        data: IntBuffer,
        ...
        nativeWriteIntBuffer(buffer, offset, dataOffset, data, size)
    }
    ...
    actual fun writeBuffer(
        ...
        nativeWriteFloatBuffer(data, buffer, offset, dataOffset, size)
    }
    ...
    actual fun writeBuffer(
        ...
        nativeWriteByteBuffer(data, buffer, offset, dataOffset, size)
    }
...
actual class Surface(val segment: WGPUSurface) : Releasable {
    ...
    actual fun getCurrentTexture(): SurfaceTexture {
        return memoryScope { scope ->
            ...
            val texture = surfaceTexture.texture?.let { WebGPUTexture(it, getNativeWebGPUTextureByteSize(it))  }
...
actual class GPUBuffer(val segment: WGPUBuffer, actual val size: Long) : Releasable {
    ...
    actual fun getMappedRange(offset: Long, size: Long): ByteBuffer {
        return nativeMappedRange(segment,offset, size)
    }
...
internal expect fun nativeMappedRange(segment: WGPUBuffer, offset: Long, size: Long) : ByteBuffer
...
expect fun getNativeWebGPUTextureByteSize(texture: WGPUTexture): Long