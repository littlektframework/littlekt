...
import com.lehaine.littlekt.util.internal.*
...
inline val Long.nanoseconds get() = TimeSpan.fromNanoseconds(this.toFloat())

/** [TimeSpan] representing this number as [microseconds] or 1 / 1_000_000 [seconds]. */
inline val Long.microseconds get() = TimeSpan.fromMicroseconds(this.toFloat())

/** [TimeSpan] representing this number as [milliseconds] or 1 / 1_000 [seconds]. */
inline val Long.milliseconds get() = TimeSpan.fromMilliseconds(this.toFloat())

/** [TimeSpan] representing this number as [seconds]. */
inline val Long.seconds get() = TimeSpan.fromSeconds((this.toFloat()))

/** [TimeSpan] representing this number as [minutes] or 60 [seconds]. */
inline val Long.minutes get() = TimeSpan.fromMinutes(this.toFloat())

/** [TimeSpan] representing this number as [hours] or 3_600 [seconds]. */
inline val Long.hours get() = TimeSpan.fromHours(this.toFloat())

/** [TimeSpan] representing this number as [days] or 86_400 [seconds]. */
inline val Long.days get() = TimeSpan.fromDays(this.toFloat())

/** [TimeSpan] representing this number as [weeks] or 604_800 [seconds]. */
inline val Long.weeks get() = TimeSpan.fromWeeks(this.toFloat())

/** [TimeSpan] representing this number as [nanoseconds] or 1 / 1_000_000_000 [seconds]. */
inline val Double.nanoseconds get() = TimeSpan.fromNanoseconds(this.toFloat())

/** [TimeSpan] representing this number as [microseconds] or 1 / 1_000_000 [seconds]. */
inline val Double.microseconds get() = TimeSpan.fromMicroseconds(this.toFloat())

/** [TimeSpan] representing this number as [milliseconds] or 1 / 1_000 [seconds]. */
inline val Double.milliseconds get() = TimeSpan.fromMilliseconds(this.toFloat())

/** [TimeSpan] representing this number as [seconds]. */
inline val Double.seconds get() = TimeSpan.fromSeconds((this.toFloat()))

/** [TimeSpan] representing this number as [minutes] or 60 [seconds]. */
inline val Double.minutes get() = TimeSpan.fromMinutes(this.toFloat())

/** [TimeSpan] representing this number as [hours] or 3_600 [seconds]. */
inline val Double.hours get() = TimeSpan.fromHours(this.toFloat())

/** [TimeSpan] representing this number as [days] or 86_400 [seconds]. */
inline val Double.days get() = TimeSpan.fromDays(this.toFloat())

/** [TimeSpan] representing this number as [weeks] or 604_800 [seconds]. */
inline val Double.weeks get() = TimeSpan.fromWeeks(this.toFloat())

/** [TimeSpan] representing this number as [nanoseconds] or 1 / 1_000_000_000 [seconds]. */
inline val Int.nanoseconds get() = TimeSpan.fromNanoseconds(this.toFloat())

/** [TimeSpan] representing this number as [microseconds] or 1 / 1_000_000 [seconds]. */
inline val Int.microseconds get() = TimeSpan.fromMicroseconds(this.toFloat())

/** [TimeSpan] representing this number as [milliseconds] or 1 / 1_000 [seconds]. */
inline val Int.milliseconds get() = TimeSpan.fromMilliseconds(this.toFloat())

/** [TimeSpan] representing this number as [seconds]. */
inline val Int.seconds get() = TimeSpan.fromSeconds((this.toFloat()))

/** [TimeSpan] representing this number as [minutes] or 60 [seconds]. */
inline val Int.minutes get() = TimeSpan.fromMinutes(this.toFloat())

/** [TimeSpan] representing this number as [hours] or 3_600 [seconds]. */
inline val Int.hours get() = TimeSpan.fromHours(this.toFloat())

/** [TimeSpan] representing this number as [days] or 86_400 [seconds]. */
inline val Int.days get() = TimeSpan.fromDays(this.toFloat())

/** [TimeSpan] representing this number as [weeks] or 604_800 [seconds]. */
inline val Int.weeks get() = TimeSpan.fromWeeks(this.toFloat())

/** [TimeSpan] representing this number as [nanoseconds] or 1 / 1_000_000_000 [seconds]. */
inline val Float.nanoseconds get() = TimeSpan.fromNanoseconds(this)

/** [TimeSpan] representing this number as [microseconds] or 1 / 1_000_000 [seconds]. */
inline val Float.microseconds get() = TimeSpan.fromMicroseconds(this)

/** [TimeSpan] representing this number as [milliseconds] or 1 / 1_000 [seconds]. */
inline val Float.milliseconds get() = TimeSpan.fromMilliseconds(this)

/** [TimeSpan] representing this number as [seconds]. */
inline val Float.seconds get() = TimeSpan.fromSeconds((this))

/** [TimeSpan] representing this number as [minutes] or 60 [seconds]. */
inline val Float.minutes get() = TimeSpan.fromMinutes(this)

/** [TimeSpan] representing this number as [hours] or 3_600 [seconds]. */
inline val Float.hours get() = TimeSpan.fromHours(this)

/** [TimeSpan] representing this number as [days] or 86_400 [seconds]. */
inline val Float.days get() = TimeSpan.fromDays(this)

/** [TimeSpan] representing this number as [weeks] or 604_800 [seconds]. */
inline val Float.weeks get() = TimeSpan.fromWeeks(this)
...
inline class TimeSpan(
    ...
    val nanoseconds: Float get() = this.milliseconds / MILLIS_PER_NANOSECOND
    ...
    val microseconds: Float get() = this.milliseconds / MILLIS_PER_MICROSECOND
    ...
    val seconds: Float get() = this.milliseconds / MILLIS_PER_SECOND

    /** Returns the total number of [minutes] for this [TimeSpan] (60 [seconds]) */
    val minutes: Float get() = this.milliseconds / MILLIS_PER_MINUTE

    /** Returns the total number of [hours] for this [TimeSpan] (3_600 [seconds]) */
    val hours: Float get() = this.milliseconds / MILLIS_PER_HOUR

    /** Returns the total number of [days] for this [TimeSpan] (86_400 [seconds]) */
    val days: Float get() = this.milliseconds / MILLIS_PER_DAY

    /** Returns the total number of [weeks] for this [TimeSpan] (604_800 [seconds]) */
    val weeks: Float get() = this.milliseconds / MILLIS_PER_WEEK
    ...
    /** Returns the total number of [milliseconds] as a [Float] */
    val millisecondsDouble: Double get() = milliseconds.toDouble()
    ...
    operator fun times(scale: Double): TimeSpan = TimeSpan((this.milliseconds * scale).toFloat())
    ...
    operator fun div(scale: Double): TimeSpan = TimeSpan((this.milliseconds / scale).toFloat())
    operator fun div(scale: Float): TimeSpan = TimeSpan((this.milliseconds / scale))

    operator fun div(other: TimeSpan): Float = this.milliseconds / other.milliseconds
    ...
    companion object {
        ...
        private const val MILLIS_PER_MICROSECOND = 1f / 1000f
        private const val MILLIS_PER_NANOSECOND = MILLIS_PER_MICROSECOND / 1000f

        /**
         * Zero time.
         */
        val ZERO = TimeSpan(0f)
         ...
         */
        val NIL = TimeSpan(Double.NaN.toFloat())

        @PublishedApi
        internal fun fromMilliseconds(ms: Float) = when (ms) {
            0f -> ZERO
            else -> TimeSpan(ms)
        }

        @PublishedApi
        internal fun fromNanoseconds(s: Float) = fromMilliseconds(s * MILLIS_PER_NANOSECOND)

        @PublishedApi
        internal fun fromMicroseconds(s: Float) = fromMilliseconds(s * MILLIS_PER_MICROSECOND)

        @PublishedApi
        internal fun fromSeconds(s: Float) = fromMilliseconds(s * MILLIS_PER_SECOND)

        @PublishedApi
        internal fun fromMinutes(s: Float) = fromMilliseconds(s * MILLIS_PER_MINUTE)

        @PublishedApi
        internal fun fromHours(s: Float) = fromMilliseconds(s * MILLIS_PER_HOUR)

        @PublishedApi
        internal fun fromDays(s: Float) = fromMilliseconds(s * MILLIS_PER_DAY)

        @PublishedApi
        internal fun fromWeeks(s: Float) = fromMilliseconds(s * MILLIS_PER_WEEK)

        private val timeSteps = listOf(60, 60, 24)
        private fun toTimeStringRaw(totalMilliseconds: Float, components: Int = 3): String {
