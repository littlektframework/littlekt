...
/**
 * The difference between 1 and the smallest floating point number of type float that is greater
 * than 1.
 */
...
val Int.prevPowerOfTwo: Int
    get() = if (isPowerOfTwo) this else (nextPowerOfTwo ushr 1)

/** Checks if [this] value is power of two */
val Int.isPowerOfTwo: Boolean
    get() = this.nextPowerOfTwo == this
...
fun subtractRadians(a: Double, b: Double): Double =
    normalizeRadian(normalizeRadian(a) - normalizeRadian(b))
