...
private inline fun ByteArray.read24LE(o: Int): Int =
    (u8(o + 0) shl 0) or (u8(o + 1) shl 8) or (u8(o + 2) shl 16)
...
private inline fun ByteArray.read24BE(o: Int): Int =
    (u8(o + 2) shl 0) or (u8(o + 1) shl 8) or (u8(o + 0) shl 16)
...
// Custom Endian
internal fun ByteArray.readU16(o: Int, little: Boolean): Int =
    if (little) readU16LE(o) else readU16BE(o)

internal fun ByteArray.readU24(o: Int, little: Boolean): Int =
    if (little) readU24LE(o) else readU24BE(o)

internal fun ByteArray.readU32(o: Int, little: Boolean): Long =
    if (little) readU32LE(o) else readU32BE(o)

internal fun ByteArray.readS16(o: Int, little: Boolean): Int =
    if (little) readS16LE(o) else readS16BE(o)

internal fun ByteArray.readS24(o: Int, little: Boolean): Int =
    if (little) readS24LE(o) else readS24BE(o)

internal fun ByteArray.readS32(o: Int, little: Boolean): Int =
    if (little) readS32LE(o) else readS32BE(o)

internal fun ByteArray.readS64(o: Int, little: Boolean): Long =
    if (little) readS64LE(o) else readS64BE(o)

internal fun ByteArray.readF32(o: Int, little: Boolean): Float =
    if (little) readF32LE(o) else readF32BE(o)

internal fun ByteArray.readF64(o: Int, little: Boolean): Double =
    if (little) readF64LE(o) else readF64BE(o)
...
): T = array.also { for (n in 0 until count) read(this, array, n, o + n * elementSize) }
...
internal fun ByteArray.readShortArrayLE(o: Int, count: Int): ShortArray =
    this.readTypedArray(o, count, 2, ShortArray(count)) { array, n, pos ->
        array[n] = readS16LE(pos).toShort()
    }

internal fun ByteArray.readCharArrayLE(o: Int, count: Int): CharArray =
    this.readTypedArray(o, count, 2, kotlin.CharArray(count)) { array, n, pos ->
        array[n] = readS16LE(pos).toChar()
    }
...
internal fun ByteArray.readLongArrayLE(o: Int, count: Int): LongArray =
    this.readTypedArray(o, count, 8, LongArray(count)) { array, n, pos ->
        array[n] = readS64LE(pos)
    }

internal fun ByteArray.readFloatArrayLE(o: Int, count: Int): FloatArray =
    this.readTypedArray(o, count, 4, FloatArray(count)) { array, n, pos ->
        array[n] = readF32LE(pos)
    }

internal fun ByteArray.readDoubleArrayLE(o: Int, count: Int): DoubleArray =
    this.readTypedArray(o, count, 8, DoubleArray(count)) { array, n, pos ->
        array[n] = readF64LE(pos)
    }

internal fun ByteArray.readShortArrayBE(o: Int, count: Int): ShortArray =
    this.readTypedArray(o, count, 2, ShortArray(count)) { array, n, pos ->
        array[n] = readS16BE(pos).toShort()
    }

internal fun ByteArray.readCharArrayBE(o: Int, count: Int): CharArray =
    this.readTypedArray(o, count, 2, kotlin.CharArray(count)) { array, n, pos ->
        array[n] = readS16BE(pos).toChar()
    }
