...
internal class Os2Parser(val buffer: ByteBuffer, val start: Int) {
    ...
    fun parse(): Os2 {
        ...
        return Os2(
            ...
            ulUnicodeRange1 = p.parseUint32.toInt(),
            ulUnicodeRange2 = p.parseUint32.toInt(),
            ulUnicodeRange3 = p.parseUint32.toInt(),
            ulUnicodeRange4 = p.parseUint32.toInt(),
            achVendID =
            ...
            ulCodePageRange1 = if (version >= 1) p.parseUint32.toInt() else 0,
            ulCodePageRange2 = if (version >= 1) p.parseUint32.toInt() else 0,
