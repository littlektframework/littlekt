...
internal open class Drawer(protected val batchManager: BatchManager) {
    ...
    fun color(c1: Color, c2: Color, c3: Color) {
        color1(c1)
        color2(c2)
        color3(c3)
    }

    fun color(c1: Color, c2: Color, c3: Color, c4: Color) {
        color1(c1)
        color2(c2)
        color3(c3)
        color4(c4)
    ...
    companion object {
        @JvmStatic protected val dir = MutableVec2f()

        @JvmStatic protected val a = MutableVec2f()

        @JvmStatic protected val b = MutableVec2f()

        @JvmStatic protected val c = MutableVec2f()

        @JvmStatic protected val d = MutableVec2f()

        @JvmStatic protected val e = MutableVec2f()

        @JvmStatic protected val vec1 = MutableVec2f()
    }
}
