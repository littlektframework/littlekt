...
class Pixmap(
    val width: Int,
    val height: Int,
    val pixels: ByteBuffer = ByteBuffer(width * height * 4)
) {

    /** Draws the given [pixmap] onto this [Pixmap]. */
    fun draw(
        pixmap: Pixmap,
        x: Int = 0,
        y: Int = 0,
            ...
            if (filtering) {
                ...
                while (i < dstHeight) {
                    ...
                    while (j < dstWidth) {
                        ...
                        val c4 =
                            if (sx + rx < srcWidth && sy + ry < srcHeight)
                                spixels.getInt(srcHeight + 4 * rx + spitch * ry)
                            else c1
                        ...
                        val r =
                            ((c1 and 0xff000000.toInt() ushr 24) * ta +
                                    (c2 and 0xff000000.toInt() ushr 24) * tb +
                                    (c3 and 0xff000000.toInt() ushr 24) * tc +
                                    (c4 and 0xff000000.toInt() ushr 24) * td)
                                .toInt() and 0xff
                        val g =
                            ((c1 and 0xff0000 ushr 16) * ta +
                                    (c2 and 0xff0000 ushr 16) * tb +
                                    (c3 and 0xff0000 ushr 16) * tc +
                                    (c4 and 0xff0000 ushr 16) * td)
                                .toInt() and 0xff
                        val b =
                            ((c1 and 0xff00 ushr 8) * ta +
                                    (c2 and 0xff00 ushr 8) * tb +
                                    (c3 and 0xff00 ushr 8) * tc +
                                    (c4 and 0xff00 ushr 8) * td)
                                .toInt() and 0xff
                        val a =
                            ((c1 and 0xff) * ta +
                                    (c2 and 0xff) * tb +
