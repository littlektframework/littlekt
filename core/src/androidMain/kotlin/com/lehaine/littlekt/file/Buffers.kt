...
abstract class GenericBuffer<out B : java.nio.Buffer>(override val capacity: Int, val buffer: B) : Buffer {
 ...
 */
class ShortBufferImpl(buffer: java.nio.ShortBuffer) : ShortBuffer,
    GenericBuffer<java.nio.ShortBuffer>(buffer.capacity(), buffer) {

    constructor(capacity: Int) : this(
        java.nio.ByteBuffer.allocateDirect(capacity * 2).order(ByteOrder.nativeOrder()).asShortBuffer()
    )
 ...
 */
class IntBufferImpl(buffer: java.nio.IntBuffer) : IntBuffer,
    GenericBuffer<java.nio.IntBuffer>(buffer.capacity(), buffer) {

    constructor(capacity: Int) : this(
        java.nio.ByteBuffer.allocateDirect(capacity * 4).order(ByteOrder.nativeOrder()).asIntBuffer()
    )
 ...
 */
class FloatBufferImpl(buffer: java.nio.FloatBuffer) : FloatBuffer,
    GenericBuffer<java.nio.FloatBuffer>(buffer.capacity(), buffer) {

    constructor(capacity: Int) : this(
        java.nio.ByteBuffer.allocateDirect(capacity * 4).order(ByteOrder.nativeOrder()).asFloatBuffer()
    )

    constructor(data: FloatArray) : this(
        java.nio.ByteBuffer.allocateDirect(data.size * 4).order(ByteOrder.nativeOrder()).asFloatBuffer()
    ) {
        put(data)
 ...
 */
class ByteBufferImpl(buffer: java.nio.ByteBuffer) : ByteBuffer,
    GenericBuffer<java.nio.ByteBuffer>(buffer.capacity(), buffer) {

    constructor(capacity: Int) : this(java.nio.ByteBuffer.allocateDirect(capacity).order(ByteOrder.nativeOrder()))
    constructor(data: ByteArray) : this(
        java.nio.ByteBuffer.allocateDirect(data.size).order(ByteOrder.nativeOrder())
    ) {
        putByte(data)
    }

    constructor(data: ByteArray, isBigEndian: Boolean) : this(
        java.nio.ByteBuffer.allocateDirect(data.size)
