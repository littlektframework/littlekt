...
val PrimitiveTopology.nativeVal: Int
    get() =
        when (this) {
...
val TextureViewDimension.nativeVal: Int
    get() =
        when (this) {
...
val TextureAspect.nativeVal: Int
    get() =
        when (this) {
...
val TextureDimension.nativeVal: Int
    get() =
        when (this) {
...
val TextureFormat.nativeVal: Int
    get() =
        when (this) {
...
val BlendOperation.nativeVal: Int
    get() =
        when (this) {
...
val StencilOperation.nativeVal: Int
    get() =
        when (this) {
...
val VertexFormat.nativeVal: Int
    get() =
        when (this) {
...
val VertexStepMode.nativeVal: Int
    get() =
        when (this) {
...
val BufferBindingType.nativeVal: Int
    get() =
        when (this) {
...
val CompareFunction.nativeVal: Int
    get() =
        when (this) {
...
val TextureSampleType.nativeVal: Int
    get() =
        when (this) {
...
val SamplerBindingType.nativeVal: Int
    get() =
        when (this) {
...
val TextureStatus.nativeVal: Int
    get() =
        when (this) {
            TextureStatus.SUCCESS -> WGPUSurfaceGetCurrentTextureStatus_Success()
...
@JvmInline
value class Backend(val flag: Int) {
