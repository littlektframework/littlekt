...
import io.ygdrasil.wgpu.BackendType
...
actual class LittleKtProps {
    ...
    /** Bitmask for backends. Defaults to [BackendType.undefined]. */
    var preferredBackends = BackendType.undefined
...
private fun loadNativesFromClasspath() {
    SharedLibraryLoader().load("wgpu_native")
}
...
class JvmConfiguration(
    ...
    val preferredBackends: BackendType,
