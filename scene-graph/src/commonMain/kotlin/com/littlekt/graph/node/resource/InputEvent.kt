...
/**
 * An [Event], specific to inputs, that tracks the input data that triggered it, for the specific
 * [InputSignal] type.
 *
 * @author Colton Daily
 * @date 1/2/2022
...
class InputEvent<InputSignal> : Event() {
    ...
    /** The button type, if any. */
    var button: Int = 0

    /** The [Key], if any */
    var key: Key = Key.ANY_KEY

    /** The input type, designated by [InputSignal]. Not to be confused with [type]. */
    ...
    /**
     * The x-coord of the current canvas. This may be equal to [sceneX] if there are no nested
     * canvases.
     */
    var canvasX: Float = 0f

    /**
     * The y-coord of the current canvas. This may be equal to [sceneY] if there are no nested
     * canvases.
     */
    var canvasY: Float = 0f

    /**
     * The x-coord of the current node in its local coordinates. (i.e a value of `0` will be the
     * left edge)
     */
    var localX: Float = 0f

    /**
     * The y-coord of the current node in its local coordinates. (i.e a value of `0` will be the top
     * edge)
     */
    var localY: Float = 0f

    /** The amount of pixels scrolled on the x-axis. */
    var scrollAmountX: Float = 0f

    /** The amount of pixels scrolled on the y-axis. */
    ...
    /** Denotes the type of input event. */
    enum class Type {
        /** No event. */
        NONE,
