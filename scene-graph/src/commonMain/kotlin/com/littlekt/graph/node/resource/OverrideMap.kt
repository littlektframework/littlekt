...
/**
 * A map that tracks when any entries are added or removed, and invokes a callback.
 *
 * @param onValueChange the lambda to trigger when [put], [putAll] or [remove] are invoked.
 * @author Colton Daily
 * @date 2/3/2022
 */
